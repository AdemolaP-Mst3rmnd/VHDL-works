...
# ACDS 22.1 915 win32 2024.03.01.09:41:16
# ----------------------------------------
...
# ----------------------------------------
# If kj_clock_generator is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "kj_clock_generator"
}
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/kj_clock_generator.vho"
}
